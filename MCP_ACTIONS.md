...
| Floor plans (preview) | Read labels/measurement notes; edit title/notes | Delete a plan and its current notes |
...
- Upload files in WantKit: the new floor-plan tab accepts images/PDFs on preview. MCP exposes saved labels/notes, not file bytes. Floor-plan interpretation and generation remain separate tasks.
