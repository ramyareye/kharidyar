/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 5cf088f5afafc7d2b2a6ef9cc823bdce)
// Runtime types generated with workerd@1.20260828.1 2025-10-08 nodejs_compat,unhandled_rejection_after_microtask_checkpoint
interface __BaseEnv_Env {
	...
	MCP_ENABLED: string;
	CHATGPT_VISUALS_ENABLED: string;
	MCP_ALLOWED_USER_IDS: string;
	RESEARCH_BROWSER_ALLOWED_ORIGIN: string;
	CONCEPT_MEDIA_MAX_FILE_BYTES: string;
	CONCEPT_MEDIA_MAX_IMAGES: string;
	CONCEPT_MEDIA_MAX_PIXEL_COUNT: string;
	CONCEPT_MEDIA_MAX_SIDE_PIXELS: string;
	CONCEPT_MEDIA_MAX_WORKSPACE_BYTES: string;
	CONCEPT_MEDIA_UPLOAD_LIMIT: string;
	CONCEPT_MEDIA_UPLOAD_WINDOW_MS: string;
